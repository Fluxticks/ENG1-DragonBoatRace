...
public enum BoatType {
    ...
    FAST(20, 15, 100, 1, 1, 1, 1000, new Vector2(41, 131), "Boats/FastBoat.PNG"),
    NORMAL(15, 10, 200, 2, 2, 2, 1000, new Vector2(82, 113), "Boats/NormalBoat.PNG"),
    HEAVY(15, 5, 400, 3, 2, 1, 1000, new Vector2(75, 120), "Boats/HeavyBoat.PNG"),
    LIGHT(15, 15, 100, 1, 1, 3, 1000, new Vector2(62, 130), "Boats/LightBoat.PNG"),
    AGILE(15, 10, 200, 2, 2, 3, 1000, new Vector2(39, 133), "Boats/AgileBoat.PNG"),
    STRONG(15, 10, 300, 3, 3, 1, 1000, new Vector2(60, 129), "Boats/StrongBoat.PNG"),
    TESTING(15, 10, 300, 1, 2, 2, 1000, new Vector2(50, 50), "Testing");

    String imageSrc;
    float speed, acceleration, maxHealth, weight, strength, handling, stamina;
    Vector2 size;
     ...
     * @param stamina      The maximum stamina of the boat type.
     * @param size         The size of the boat type.
     * @param imageSrc     The path of the image source used as the boat types texture.
     */
    BoatType(float speed, float acceleration, float maxHealth, float weight, float strength, float handling, float stamina, Vector2 size, String imageSrc) {
        this.speed = speed;
    ...
    /**
     * Get the maximum stamina of the boat type.
     *
     * @return A float of the boat type's max stamina.
     */
